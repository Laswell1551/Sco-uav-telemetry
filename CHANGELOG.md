...
- finalized the three-author software and citation metadata;
- added the 3x4 capacity--delay recovery trajectories, frozen source rows,
  summary, renderer, and endpoint/zero-delay audits;
- added public security, conduct, release, and archival-readiness guidance.

## 0.1.0-rc1

- assembled the initial SCO/PA-SCO reproduction candidate with frozen
  artifacts, tests, renderers, provenance checks, and external-data boundaries.
