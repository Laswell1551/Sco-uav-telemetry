...
def build_provenance(
    ...
    sources = {
        "run_tmc_v16_baseline_expansion.py": root / "experiments" / "run_tmc_v16_baseline_expansion.py",
        "run_uzh_trace_replay.py": root / "experiments" / "run_uzh_trace_replay.py",
        "run_m3ed_trace_replay.py": root / "experiments" / "run_m3ed_trace_replay.py",
...
def main():
    ...
    started = time.perf_counter()
    uzh_bank = load_all_replay_traces(args.uzh_data_root)
    m3ed_bank = load_all_falcon_pose(args.m3ed_data_root)
    datasets = {
